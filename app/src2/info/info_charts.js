define(['exports', 'module', 'd3', 'postal', '../components/chart3', '../patients', '../tag_selection', '../service'], function (exports, module, _d3, _postal, _componentsChart3, _patients, _tag_selection, _service) {
  ...
  module.exports = function () {
    ...
    var summaryData = [];
    var summaryChart = (0, _chart3['default'])('#summary-chart', true).title('summary');
    ...
    _postal2['default'].subscribe({ channel: 'global', topic: 'highlight.topic', callback: highlight });
    ...
    function highlight(node) {
      if (node.show) highlighted = node.topic;else highlighted = null;
      render();
    }
